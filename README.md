...
> [Faelei MIDI Player 1.0.6](https://daniferous.github.io/aranara-midi-player-sb3/faelei/Faelei%20MIDI%20Player%201.0.6.html) (This version uses [Faelei MIDI Files](https://github.com/Daniferous/MidiParser/tree/Faelei).)
...
> [Faelei MIDI Render Toolkit 1.6.9](https://daniferous.github.io/aranara-midi-player-sb3/faelei/Faelei%20MIDI%20Render%20Toolkit%201.6.9.html) (This version uses [Faelei MIDI Files](https://github.com/Daniferous/MidiParser/tree/Faelei).)
...
## Convert MIDIs to Faelei and Aranara MIDIs:

1. Faelei MIDI Format:<br>[Modded MIDIParser - Faelei](https://github.com/Daniferous/MidiParser/tree/Faelei)

2. Aranara MIDI Format:<br>[Modded MIDIParser - Latest](https://github.com/daniferous/MidiParser/releases/tag/build-24.03.15)

>[Click here to decide which Format to convert your MIDI into.](https://daniferous.github.io/aranara-midi-player-sb3/versions)

## (Legacy) Split Large AraMIDIs into AraMIDI slices:
